...
import { useExerciseLibrary, useCreateLibraryEntry, useUpdateLibraryEntry, useDeleteLibraryEntry } from './queries'
...
/** Bibliothek aus Übungsvorlagen: Schema und Pause je Übungsname, einmal
    ...
    Reine Vorlage, keine Verknüpfung: NeueUebungForm (SessionView.tsx)
    übernimmt Schema/Pause beim Anlegen nur als Startwert. Eine spätere
    Änderung hier wirkt sich nicht auf schon angelegte Übungen aus, und
    umgekehrt ändert das Bearbeiten einer Übung nie die Bibliothek. */
export function ExerciseLibraryPage() {
  const { data: eintraege } = useExerciseLibrary()
